window.__ModuleLoader__.load({
	id: "@zhaoan2308184882-spec/dsh-llm-codex",
	factory: (require) => {
		var module = { exports: {} };
		...
		function ProviderEditor(props) {
			...
			*/
			...
			const codexFields = () => {
				...
				return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [textFields.map(([key, label]) => (0, react_jsx_runtime.jsxs)("div", {
					className: ModelsSection_module_css_default["field"],
					children: [(0, react_jsx_runtime.jsx)("span", {
						className: ModelsSection_module_css_default["fieldLabel"],
						children: label
						...
						className: ModelsSection_module_css_default["input"],
						type: "text",
						value: stringAt(draft, key) ?? "",
						placeholder: stringAt(fallback, key) ?? "",
						"aria-label": label,
						disabled,
						onChange: (event) => { setField(key, event.target.value === "" ? void 0 : event.target.value); }
					})]
				}, key)), (0, react_jsx_runtime.jsxs)("div", {
					className: ModelsSection_module_css_default["field"],
					children: [(0, react_jsx_runtime.jsx)("span", {
						className: ModelsSection_module_css_default["fieldLabel"],
						...
						className: `${ModelsSection_module_css_default["input"]} ${ModelsSection_module_css_default["selectInput"]}`,
						value: stringAt(draft, "sandboxMode") ?? stringAt(fallback, "sandboxMode") ?? "read-only",
						"aria-label": "Sandbox mode",
						disabled,
						onChange: (event) => { setField("sandboxMode", event.target.value); },
						children: ["read-only", "workspace-write", "danger-full-access"].map((value) => (0, react_jsx_runtime.jsx)("option", { value, children: value }, value))
					})]
				}), (0, react_jsx_runtime.jsxs)("div", {
					className: ModelsSection_module_css_default["field"],
					children: [(0, react_jsx_runtime.jsx)("span", {
						className: ModelsSection_module_css_default["fieldLabel"],
						children: "Default reasoning effort"
					}), (0, react_jsx_runtime.jsx)("select", {
						className: `${ModelsSection_module_css_default["input"]} ${ModelsSection_module_css_default["selectInput"]}`,
						value: stringAt(draft, "defaultReasoningEffort") ?? stringAt(fallback, "defaultReasoningEffort") ?? "low",
						"aria-label": "Default reasoning effort",
						disabled,
						onChange: (event) => { setField("defaultReasoningEffort", event.target.value); },
						children: ["low", "medium", "high", "xhigh", "max", "ultra"].map((value) => (0, react_jsx_runtime.jsx)("option", { value, children: value }, value))
					})]
				})] });
			};
			/**
			...
			*/
			const curatedFields = (family) => {
				...
				return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [family === "codex" ? null : (0, react_jsx_runtime.jsxs)("div", {
					className: ModelsSection_module_css_default["field"],
					children: [
						(0, react_jsx_runtime.jsx)("span", {
							className: ModelsSection_module_css_default["fieldLabel"],
					...
					children: [(0, react_jsx_runtime.jsx)("summary", {
						...
						children: [
							...
							family === "codex" ? null : (0, react_jsx_runtime.jsxs)("div", {
								className: ModelsSection_module_css_default["field"],
								children: [(0, react_jsx_runtime.jsx)("span", {
									className: ModelsSection_module_css_default["fieldLabel"],
									children: t("baseUrl")
